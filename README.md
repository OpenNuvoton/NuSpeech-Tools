---------------------------------------------------------
NSP ICP Writer V2.04.000
---------------------------------------------------------
1. Support offline mode for the NSP2340BA24, NSP2170BA24, and NSP2080BA24 chips
2. Support new NSP commands used when updating ISP data in 4-byte mode for the NSP2340B chip project
3. Support new NSP commands [PWM_SPEAKER_START] and [PWM_SPEAKER_STOP] for the NSP2 chip project
4. Fixed issue where offline chip programming and checksum-based verification failed on the NSP2K0 chip
5. Fixed issue where multiple RBF files could not be generated when extracting NSP2/NSR OBJ files
6. Adjusted the resource update process (both full and single resource updates) to prevent update failures
7. Updated mass storage firmware files:
   - [5A.03.13.0F] for Auto-Version Dongle  
   - [5A.03.17.0B] for Factory-Version Dongle  
   - [5A.05.0E.11] for Normal-Version Dongle
