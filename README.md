-------------
Speech ICP Writer V2.08.000
-------------
Based on V2.07.000.

[Features]
+ Support for chips N589L345, N589L255, N589L205, N589L175, N589L125, and N589L085 package TSSOP20, TSSOP28
+ Support the offline mode to increase unique ID number function
+ Clear message window when chip status changes to disconnected to avoid confusion
+ Update mass storage firmware files
 - [5A.07.01.12] for Auto-Version Dongle
 - [5A.07.01.13] for Factory-Version Dongle
 - [5A.07.01.11] for Normal-Version Dongle

-------------
Speech ICP Writer V2.07.000
-------------
Based on V2.06.000.

[Features]
+ Support for programming SPI Flash using the N589D [1K5|2K0] DIE, TSSOP-28, or LQFP-48 packages
